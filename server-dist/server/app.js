...
app.post("/api/generate-floorplan", upload.fields([
...
async function generateWithNanoBanana(blueprint, styleReference, photos, hints) {
...
function friendlyGeminiError(message, model) {
